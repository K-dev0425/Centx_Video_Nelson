    ...
    case "update_video":
        {
            ...
            $queryd .= "UPDATE " . tbl("video") . " SET type = '" . $type . "', pay_type = '" . $pay_type . "', allowed_min_age = " . (int)$allowed_min_age . ", allowed_max_age = " . (int)$allowed_max_age . ", allowed_gender = '" . $allowed_gender . "', allowed_country = '" . $allowed_country . "', 
